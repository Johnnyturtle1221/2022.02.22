...
class Tetris(object):
    ...
    def draw_board(self):
        ...
        """
        pygame.draw.rect(self.screen,constants.BLACK,self.board_up)
        pygame.draw.rect(self.screen,constants.BLACK,self.board_down)
        pygame.draw.rect(self.screen,constants.BLACK,self.board_left)
        pygame.draw.rect(self.screen,constants.BLACK,self.board_right)
        # Update the score         
        self.print_status_line()
